...
from games.graphons import uniform_attachment_graphon, er_graphon, ranked_attachment_graphon, power_law_graphon, cutoff_power_law_graphon
...
def parse_args():
    ...
    parser.add_argument('--evaluator', help='evaluator', choices=['exact', 'stochastic', 'reg'])
