...
class FIXMFGGymWrapper(Env):
    def __init__(self, mfg: MeanFieldGame, mu: MeanField, alpha=0.5, time_obs_augment=True):
        self.mfg = mfg
        self.mu = mu
    ...
    def reset(self):
        ...
        self.x = (np.array(self.alpha, dtype=float32), self.x[1])
        self.t = 0
